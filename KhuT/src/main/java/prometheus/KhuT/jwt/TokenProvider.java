...
import prometheus.KhuT.Domain.RefreshToken;
import prometheus.KhuT.Dto.Login.AccessTokenRequest;
import prometheus.KhuT.Dto.Token.TokenDto;
import prometheus.KhuT.Exception.handler.JwtHandler;
import prometheus.KhuT.Repository.RefreshTokenRepository;
...
//    }
    public TokenDto createToken(Authentication authentication) {
        ...
        prometheus.KhuT.Domain.User user = memberRepository.findByUsername(authentication.getName())
                .orElseThrow();
